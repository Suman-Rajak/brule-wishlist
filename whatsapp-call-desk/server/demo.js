...
const CHATS = [
  // ---------- Call first: read your message and went quiet ----------
  {
    name: 'Ananya Iyer',
    msgs: [
      [ago(4, 3), 'them', 'Hi! Saw Brulé on Instagram 😍 Do you do corporate gift boxes? Need around 30 for Diwali'],
      [ago(4, 2, 40), 'me', 'Hi Ananya! Yes we do ☕ Our Dolce Vita box has 250g of house blend, a ceramic mug and postcards. ₹1,450 each, ₹1,250 each for 25+'],
      [ago(4, 2, 38), 'them', 'Ooh nice. Can you add our logo somewhere?'],
      [ago(4, 2, 30), 'me', 'Absolutely — we can print a custom note card with your logo in every box.'],
      [ago(2, 1), 'me', '', { type: 'document', body: '[document: Brule-Gifting-Catalogue.pdf]' }],
      [ago(2, 0, 58), 'me', 'Here’s the full catalogue. Shall I hold 30 boxes for you? Diwali orders close on the 10th.', { ack: 3 }],
    ],
    analysis: {
      category: 'lead', interest: 86, sentiment: 'positive', endedOnGoodNote: true, expectsReply: true,
      intent: '30 Diwali gift boxes',
      summary: 'Wants about 30 corporate Diwali gift boxes with her company logo. You sent pricing and the catalogue; she read it two days ago but hasn’t confirmed.',
  ...
  },
  {
    ...
    note: 'Ember Café',
    msgs: [
      [ago(6, 5), 'them', 'Hey, I run Ember Café in Indiranagar. Looking for a new roaster for our espresso. Do you supply cafés?'],
      [ago(6, 4), 'me', 'Hi Rohan! We do. Our house espresso blend is medium-dark, chocolatey, great with milk. Happy to send a 1kg trial bag.'],
      [ago(5, 22), 'them', 'Trial would be great. We go through ~5kg a month'],
      [ago(3, 2), 'them', 'Got the trial bag, the team liked it 👍 what’s the price for 5kg monthly?'],
      [ago(1, 2), 'me', 'So glad! For 5kg/month it’s ₹1,180/kg with free delivery, roasted fresh every week. Want me to set up the first order for Monday?', { ack: 3 }],
    ],
    analysis: {
      category: 'lead', interest: 81, sentiment: 'positive', endedOnGoodNote: true, expectsReply: true,
      intent: 'Wholesale espresso for café',
      summary: 'Café owner buying ~5kg a month. His team liked the trial bag; you quoted ₹1,180/kg and he read it yesterday without replying.',
  ...
  },
  {
    name: 'Arjun Kapoor',
    msgs: [
      [ago(5, 6), 'them', 'Bro the sample pack was 🔥🔥 the Chikmagalur one especially'],
      [ago(5, 5), 'me', 'Haha thank you Arjun! That one’s my favourite too ☕'],
      [ago(0, 20), 'me', 'We’re starting a monthly subscription — 2 bags a month, 15% off. Want me to put you down for the first batch?', { ack: 3 }],
    ],
    analysis: {
      category: 'lead', interest: 72, sentiment: 'positive', endedOnGoodNote: true, expectsReply: true,
      intent: 'Monthly subscription',
      summary: 'Loved the sample pack, especially the Chikmagalur single origin. You offered the monthly subscription; he read it 20 hours ago.',
